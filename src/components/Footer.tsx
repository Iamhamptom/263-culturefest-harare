...
export default function Footer() {
  return (
    <footer className="bg-gray-50 border-t border-gray-200 py-16 md:py-24">
      <div className="max-w-[1400px] mx-auto px-8 grid grid-cols-1 md:grid-cols-4 gap-12">
        <div className="md:col-span-2">
          <Link to="/" className="text-2xl font-display font-extrabold tracking-[0.1em] text-black uppercase mb-6 block">
            263 CULTUREFEST
          </Link>
          <p className="text-gray-600 max-w-sm mb-8">
            Artists. AI. African Innovation Leadership. A premium gathering built around culture, systems, and the future.
          </p>
      ...
      <div className="max-w-[1400px] mx-auto px-8 mt-16 pt-8 border-t border-gray-200 flex flex-col md:flex-row justify-between items-center gap-4">
        <p className="text-gray-500 text-sm">
          &copy; 2026 Visio Research Lab / 263. All rights reserved.
        </p>
